...
class QuotesSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for i in range(1, 3247, 1):
            l = 'http://news.einfomax.co.kr/news/articleList.html?page={}&total=97383&sc_area=A&view_type=sm&sc_sdate=2015-01-01&sc_edate=2020-07-12&sc_order_by=E&sc_word=%EA%B8%88%EB%A6%AC&sc_andor=OR'.format(i)
            urls.append(l)
